...
* https://adoptium.net/[OpenJDK 21 with HotSpot JVM] (recommended) -- from Scala SDK 1.5.1 onwards
* https://www.oracle.com/java/technologies/downloads/#jdk21[Oracle JDK 21 (recommended)] -- from Scala SDK 1.5.1 onwards
