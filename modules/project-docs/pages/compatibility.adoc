...
The Couchbase Scala SDK 1.x Client supports Scala 2.12
// and 2.13.
...
Scala SDK *1.1.3* is the latest version compatible with Server 7.0β.

Later SDK 1.x releases will be limited to the Default Scope and Collection with the beta 7.0 server, and will only be fully compatible with the full release version.
====
