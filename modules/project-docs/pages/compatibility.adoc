...
The Couchbase Scala SDK 1.2 Client supports Scala 2.12 and 2.13.
...
At time of release, the Couchbase 1.2 Scala SDK is fully compatible with Couchbase Capella, our fully-hosted database-as-a-service.
