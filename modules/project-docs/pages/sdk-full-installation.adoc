...
[source,sbt]
----
libraryDependencies += "com.couchbase.client" %% "scala-client" % "1.4.6"
----
...
----
dependencies {
    compile group: 'com.couchbase.client', name: 'scala-client_2.12', version: '1.4.6'
}
----
...
----
dependencies {
    compile group: 'com.couchbase.client', name: 'scala-client_2.13', version: '1.4.6'
}
----
