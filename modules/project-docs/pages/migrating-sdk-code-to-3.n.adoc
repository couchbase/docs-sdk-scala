...
1.x is the first release of the Couchbase Scala SDK, implementing https://github.com/couchbaselabs/sdk-rfcs/tree/master/rfc[Couchbase SDK3 APIs];
there are no releases of the Scala SDK implementing older APIs.
