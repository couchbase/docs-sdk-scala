...
Version 1.0.7 is the eighth release of the Scala SDK.
...
=== Bug Fixes
* https://issues.couchbase.com/browse/SCBC-247[SCBC-247]: Remove cas from `IncrementOptions` and `DecrementOptions`.  CAS is not supported by the underlying protocol and should not have been exposed in these options.
...
* https://issues.couchbase.com/browse/JVMCBC-869[JVMCBC-869]: Maintenance dependency bump: Netty -> 4.1.51, Jackson -> 2.11.1, Reactor -> 3.3.7, OpenTelemetry -> 0.6.0, Reactor Scala Extensions -> 0.7.1
