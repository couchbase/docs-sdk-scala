...
Version 1.8 of the Scala SDK implements the 3.6 xref:compatibility.adoc#api-version[SDK API].
See the xref:compatibility.adoc#couchbase-feature-availability-matrix[compatibility pages] for more information on feature compatibility with different versions of Couchbase Server.
...
Version 1.8.0 is the GA release of the 1.8 series.
...
# Release notes - Scala Couchbase Client - 1.8.0
...
[SCBC-459](https://couchbasecloud.atlassian.net/browse/SCBC-459) Implement Zone Aware Read from Replica 
