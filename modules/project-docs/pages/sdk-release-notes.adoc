...
Fix a regression introduced in Scala SDK 1.4.3 that caused JsonArray and JsonObject to no longer be handled correctly when used as parameters in QueryOptions, and in SearchOptions.raw
