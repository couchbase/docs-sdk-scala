...
== Version 1.2.7 (25 April 2022)
This bugfix release brings stability to the 1.2.x branch of the SDK.

https://docs.couchbase.com/sdk-api/couchbase-scala-client-1.2.7/com/couchbase/client/scala/index.html[API Reference]
http://docs.couchbase.com/sdk-api/couchbase-core-io-2.2.7/[Core API Reference]

The supported and tested dependencies for this release are:

* com.couchbase.client:**scala-client:1.2.7**
