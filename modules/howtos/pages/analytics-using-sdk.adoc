...
NOTE: The Scala 3 version of the SDK does not carry forward support for analytics.  Please see xref:project-docs:migrating-to-scala-3.adoc[Migrating to Scala 3] for guidance on these and other changes.
