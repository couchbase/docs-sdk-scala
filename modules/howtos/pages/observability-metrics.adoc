...
[source,scala]
----
include::example$Metrics.scala[tag=imports,indent=0]
----
...
[source,java]
----
include::example$Metrics.scala[tag=metrics-enable,indent=0]
----
...
[source,java]
----
include::example$Metrics.scala[tag=metrics-enable-custom,indent=0]
----
...
[source,scala]
----
include::example$Metrics.scala[tag=metrics-otel,indent=0]
----
