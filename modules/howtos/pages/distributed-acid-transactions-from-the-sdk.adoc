...
[source,scala]
----
include::example$TransactionsExample.scala[tag=examples,indent=0]
----
--
...
[source,scala]
----
include::example$TransactionsExample.scala[tag=examplesReactive,indent=0]
----
--
====
...
[source,scala]
----
include::example$TransactionsExample.scala[tag=logging,indent=0]
----
--
...
[source,scala]
----
include::example$TransactionsExample.scala[tag=async_logging,indent=0]
----
--
====
...
[source,scala]
----
include::example$TransactionsExample.scala[tag=insert,indent=0]
----
--
...
[source,scala]
----
include::example$TransactionsExample.scala[tag=insertReactive,indent=0]
----
--
====
...
[source,scala]
----
include::example$TransactionsExample.scala[tag=get,indent=0]
----
...
[source,scala]
----
include::example$TransactionsExample.scala[tag=get-catch,indent=0]
----
...
[source,scala]
----
include::example$TransactionsExample.scala[tag=getReadOwnWrites,indent=0]
----
...
[source,scala]
----
include::example$TransactionsExample.scala[tag=replace,indent=0]
----
--
...
[source,scala]
----
include::example$TransactionsExample.scala[tag=replaceReactive,indent=0]
----
--
====
...
[source,scala]
----
include::example$TransactionsExample.scala[tag=remove,indent=0]
----
--
...
[source,scala]
----
include::example$TransactionsExample.scala[tag=removeReactive,indent=0]
----
...
[source,scala]
----
include::example$TransactionsExample.scala[tag=queryExamplesSelectScope,indent=0]
----
...
[source,scala]
----
include::example$TransactionsExample.scala[tag=queryExamplesUpdate,indent=0]
----
...
[source,scala]
----
include::example$TransactionsExample.scala[tag=queryExamplesComplex,indent=0]
----
...
[source,scala]
----
include::example$TransactionsExample.scala[tag=queryInsert,indent=0]
----
...
[source,scala]
----
include::example$TransactionsExample.scala[tag=queryOptions,indent=0]
----
...
[source,scala]
----
include::example$TransactionsExample.scala[tag=queryRyow,indent=0]
----
...
[source,scala]
----
include::example$TransactionsExample.scala[tag=concurrentOps,indent=0]
----
...
[source,scala]
----
include::example$TransactionsExample.scala[tag=config,indent=0]
----
