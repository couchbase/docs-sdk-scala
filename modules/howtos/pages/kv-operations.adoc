...
As well as various xref:concept-docs:data-model.adoc[Formats] of JSON, Couchbase can work directly with xref:concept-docs:non-json.adoc[arbitrary bytes, or binary format].
