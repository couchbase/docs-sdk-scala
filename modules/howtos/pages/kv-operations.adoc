...
Before proceeding, make sure you're familiar with the basics of authorization and connecting to a Cluster from the xref:1.0@scala-sdk:hello-world:start-using-sdk.adoc[Start Using the SDK] section.
