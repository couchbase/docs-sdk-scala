...
[source,scala]
----
include::example$KvRangeScan.scala[tag=rangeScanAllDocuments,indent=0]
----
...
[source,scala]
----
include::example$KvRangeScan.scala[tag=rangeScanPrefix,indent=0]
----
...
[source,scala]
----
include::example$KvRangeScan.scala[tag=rangeScanSample,indent=0]
----
...
[source,scala]
----
include::example$KvRangeScan.scala[tag=rangeScanAllDocumentIds,indent=0]
----
