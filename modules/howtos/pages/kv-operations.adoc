...
NOTE: The Scala 3 version of the SDK removes direct support for external JSON libraries and direct handling of case classes, though it remains easy to integrate both.    Please see xref:project-docs:migrating-to-scala-3.adoc[Migrating to Scala 3] for guidance on these and other changes.
...
If your application does many scans at once, or requires low latency results, we recommend using {sqlpp} instead of KV range scan.
...
[source,scala]
----
include::devguide:example$scala/KvRangeScan.scala[tag=rangeScanAllDocuments,indent=0]
----
...
[source,scala]
----
include::devguide:example$scala/KvRangeScan.scala[tag=rangeScanPrefix,indent=0]
----
...
[source,scala]
----
include::devguide:example$scala/KvRangeScan.scala[tag=rangeScanSample,indent=0]
----
...
[source,scala]
----
include::devguide:example$scala/KvRangeScan.scala[tag=rangeScanAllDocumentIds,indent=0]
----
