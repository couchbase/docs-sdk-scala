...
// TODO link
Before you get started you may wish to checkout the N1QL intro page TODO LINK.
...
The examples below will use the travel-sample example bucket, which can be installed through the Couchbase Admin UI in Settings -> Sample Buckets.
