...
:lang: Scala
:example-source: 1.1@scala-sdk:howtos:example$Queries.scala
:example-source-lang: scala

include::1.1@scala-sdk:howtos:partial$n1ql-intro.adoc[]
include::1.1@scala-sdk:howtos:partial$n1ql-getting-started.adoc[]
...
include::1.1@scala-sdk:howtos:partial$n1ql-placeholders.adoc[]
include::1.1@scala-sdk:howtos:partial$n1ql-scan-consistency.adoc[]
...
From version 1.0.9 of the Scala SDK, it is possible to query off the xref:7.0@server:learn:data/scopes-and-collections.adoc[`Scope` level] _with the beta version of the next Couchbase Server release, 7.0β_,
...
include::1.1@scala-sdk:howtos:partial$n1ql-additional-resources.adoc[]
