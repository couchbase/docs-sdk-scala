...
You can atomically and efficiently update and retrieve _parts_ of a document.
...
IMPORTANT: The Sub-Document operations described on this page are for _Key-Value_ requests only: they are not related to xref:cloud:n1ql:n1ql-intro/queriesandresults.adoc#paths[Sub-Document {sqlpp} queries].
...
[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=imports,indent=0,indent=0]
----

.Retrieve Sub-Document value
[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=get]
----
...
[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=get-flatmap]
----
...
[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=get-forcomp]
----

.Check existence of Sub-Document path
[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=exists]
----
...
[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=combine]
----
...
[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=upsert]
----
...
[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=insert]
----
...
[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=multi]
----
...
See the xref:kv-operations.adoc#json[Data Operations page] for more details.
...
[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=array-append]
----

[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=array-prepend]
----
...
[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=array-create]
----
...
[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=array-upsert]
----
...
[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=array-unique]
----
...
[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=array-insert]
----
...
[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=counter-inc]
----
...
[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=counter-dec]
----
...
[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=create-path]
----


////
Multiple sub-document operations (for a single document) can be specified in a single sub-document request.
To perform sub-document operations on a (bulk) list of documents, follow the bulk operations documentation, substituting the insert calls with subdocument (lookupIn, mutateIn) calls. Notice that the .NET, Java and Nodejs samples just use the single APIs in an efficient pattern for their language.  Python has _multi() APIs (which, in turn use the single APIs in an efficient pattern).
////
...
[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=lookup-in-any-replica,indent=0]
----

If no replica or active returns a successful result, a `Failure(DocumentUnretrivableException)` is returned.
This includes if the document does not exist.

The `collection.lookupInAllReplicas()` fetches all available replicas (and the active), and returns all responses.

[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=lookup-in-all-replicas,indent=0]
----
...
[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=concurrent]
----
...
[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=cas]
----


== Durability

Couchbase's https://docs-archive.couchbase.com/java-sdk/2.7/durability.html[traditional durability], using `PersistTo` and `ReplicateTo`, is
...
[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=durability,indent=0]
----
...
[source,scala]
----
include::devguide:example$scala/SubDocument.scala[tag=sync-durability,indent=0]
----
