...
[source,scala]
----
include::devguide:example$scala/Logging.scala[indent=0,tag=example1]
----
...
[source,scala]
----
include::devguide:example$scala/Logging.scala[indent=0,tag=env]
----
...
[source,scala]
----
include::devguide:example$scala/Logging.scala[indent=0,tag=events]
----
