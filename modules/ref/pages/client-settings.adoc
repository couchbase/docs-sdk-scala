...
[source,scala]
----
include::example$ClientSettings.scala[tag=create-env-simple,indent=0]
----
...
[source,scala]
----
include::example$ClientSettings.scala[tag=timeout,indent=0]
----
...
[source,scala]
----
include::example$ClientSettings.scala[tag=system-properties,indent=0]
----
...
[source,scala]
----
include::example$ClientSettings.scala[tag=security,indent=0]
----
...
Default:  `false`
+
ystem Property: `com.couchbase.env.security.enableTls`
+
...
[source,scala]
----
include::example$ClientSettings.scala[tag=io-config,indent=0]
----
...
[source,scala]
----
include::example$ClientSettings.scala[tag=circuit-breaker,indent=0]
----
...
[source,scala]
----
include::example$ClientSettings.scala[tag=compression,indent=0]
----
...
[source,scala]
----
include::example$ClientSettings.scala[tag=general,indent=0]
----
