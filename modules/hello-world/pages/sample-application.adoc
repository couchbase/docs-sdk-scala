...
// swagger_ui::https://raw.githubusercontent.com/couchbaselabs/try-cb-scala/main/swagger.json
swagger_ui::https://raw.githubusercontent.com/couchbaselabs/try-cb-scala/HEAD/swaggerui/swagger.json[]
