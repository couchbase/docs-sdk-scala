...
The latest version, as of April 2021, is 1.1.4.

It can be included in your SBT build like this:

[source,sbt]
----
libraryDependencies += "com.couchbase.client" %% "scala-client" % "1.1.4"
----
...
----
dependencies {
    compile group: 'com.couchbase.client', name: 'scala-client_2.12', version: '1.1.4'
}
----
