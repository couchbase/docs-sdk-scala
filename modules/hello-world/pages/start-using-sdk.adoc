...
Our new Scala SDK offers functional programming-friendly ways of working with Couchbase; interoperability with the Java SDK; first class integration with the _akka_ stack; and native _Spark_ integration.

== Installing the SDK

The Couchbase Scala SDK is available on the Maven repository.
The last 1.0.n version was 1.0.10 (xref:1.1@scala-sdk:project-docs:sdk-release-notes.adoc[1.1.n versions of the SDK are now available], with better compatibility witm new features in Couchbase 6.6 and 7.0β).
...
----
dependencies {
    compile group: 'com.couchbase.client', name: 'scala-client_2.12', version: '1.0.10'
}
----
...
[source,sbt]
----
libraryDependencies += "com.couchbase.client" %% "scala-client" % "1.0.10"
----
