...
The latest version, as of December 2021, is 1.2.4.
...
----
dependencies {
    compile group: 'com.couchbase.client', name: 'scala-client_2.12', version: '1.2.4'
}
----
...
----
dependencies {
    compile group: 'com.couchbase.client', name: 'scala-client_2.13', version: '1.2.4'
}
----
