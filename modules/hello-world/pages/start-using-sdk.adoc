...
[source,scala]
----
include::partial$Cluster.scala[tag=cluster]
----
...
[source,scala]
----
include::partial$Cluster.scala[tag=resources]
----
...
[source,scala]
----
include::partial$Cluster.scala[tag=json]
----
...
[source,scala]
----
include::partial$Cluster.scala[tag=upsert]
----
...
[source,scala]
----
include::partial$Cluster.scala[tag=get]
----
...
[source,scala]
----
include::partial$Cluster.scala[tag=get-map]
----
...
[source,scala]
----
include::partial$Cluster.scala[tag=get-for]
----
