...
// https://github.com/couchbase/docs-sdk-scala/tree/release/1.7/modules/devguide/examples/scala
// 
// It can be seen built at
// https://docs.couchbase.com/scala-sdk/3.9/hello-world/start-using-sdk.html
