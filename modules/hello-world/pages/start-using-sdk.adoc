...
The latest version, as of October 2021, is 1.2.2.
...
[source,sbt]
----
libraryDependencies += "com.couchbase.client" %% "scala-client" % "1.2.2"
----
...
----
dependencies {
    compile group: 'com.couchbase.client', name: 'scala-client_2.12', version: '1.2.2'
}
----
...
----
dependencies {
    compile group: 'com.couchbase.client', name: 'scala-client_2.13', version: '1.2.2'
}
----
...
+
--
You connect to a Couchbase Cloud cluster the same as any other cluster, except that the use of TLS and a certificate is mandatory, and the "couchbases://" connection string prefix should be used to allow DNS SRV lookup.
