...
The latest version, as of February 2022, is 1.2.5.
...
[source,sbt]
----
libraryDependencies += "com.couchbase.client" %% "scala-client" % "1.2.5"
----
...
----
dependencies {
    compile group: 'com.couchbase.client', name: 'scala-client_2.12', version: '1.2.5'
}
----
...
----
dependencies {
    compile group: 'com.couchbase.client', name: 'scala-client_2.13', version: '1.2.5'
}
----
