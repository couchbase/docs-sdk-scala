...
[source,scala]
----
include::howtos:example$TransactionsExample.scala[tag=config-expiration,indent=0]
----
...
[source,scala]
----
include::howtos:example$TransactionsExample.scala[tag=config-expiration-per,indent=0]
----
...
[source,scala]
----
include::howtos:example$TransactionsExample.scala[tag=full-error-handling,indent=0]
----
