...
[source,scala]
----
include::howtos:example$TransactionsExample.scala[tag=create-simple,indent=0]
----
...
[source,scala]
----
include::howtos:example$TransactionsExample.scala[tag=rollback-cause,indent=0]
----
...
[source,scala]
----
include::howtos:example$TransactionsExample.scala[tag=custom-metadata,indent=0]
----
...
[source,scala]
----
include::howtos:example$TransactionsExample.scala[tag=custom-metadata-per,indent=0]
----
