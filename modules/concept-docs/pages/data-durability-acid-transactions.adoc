...
This can be from the {anyreplica-api}[data service],
and xref:howtos:subdocument-operations.adoc#reading-sub-documents-from-replicas[SubDoc Read from Replica].
The method can either be one to return either the first result returned -- active or replica --
