...
:page-toclevels: 2
:anyreplica-api: pass:n[https://docs.couchbase.com/sdk-api/couchbase-scala-client/com/couchbase/client/scala/Collection.html#getAnyReplica(id:String,options:com.couchbase.client.scala.kv.GetAnyReplicaOptions):scala.util.Try{startsb}com.couchbase.client.scala.kv.GetReplicaResult{endsb}]
