...
[source,scala]
----
include::howtos:example$TransactionsExample.scala[tag=config-cleanup,indent=0]
----
...
[source,scala]
----
include::howtos:example$TransactionsExample.scala[tag=cleanup-events,indent=0]
----
