...
This branch documents the 1.8 release of the SDK.
It follows the https://docs.couchbase.com/scala-sdk/1.8/project-docs/compatibility.html#api-version[SDK 3.7 API].
