...
This repository hosts the documentation source for the https://docs.couchbase.com/scala-sdk/3.12/hello-world/overview.html[Couchbase Scala SDK].

This branch documents the 3.12 release of the SDK.
It follows the https://docs.couchbase.com/scala-sdk/3.12/project-docs/compatibility.html#api-version[SDK 3.10 API].
