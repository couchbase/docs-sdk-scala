...
This repository hosts the documentation source for the https://docs.couchbase.com/scala-sdk/3.9/hello-world/overview.html[Couchbase Scala SDK].

This branch documents the 3.9 release of the SDK.
It follows the https://docs.couchbase.com/scala-sdk/3.9/project-docs/compatibility.html#api-version[SDK 3.8 API].
...
Production branches use the *release/x.y* naming pattern (e.g. `release/3.9`, `release/3.8`).
